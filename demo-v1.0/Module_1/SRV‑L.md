...
```bash
# Настойка hostname
hostnamectl set-hostname srv-l.au-team.irpo; exec bash
```
...
- «Родительский» указываем интерфейс в сторону rtr-l (ens224)
...
@	IN SOA	@ rname.invalid. (
	...
	IN	NS	au-team.irpo.
	IN	A	192.168.100.2
rtr-l	IN	A	192.168.200.1
rtr-l	IN	A	192.168.100.1
rtr-l	IN	A	192.168.0.1
rtr-r	IN	A	192.168.250.1
srv-l	IN	A	192.168.100.2
cli-l	IN	A	192.168.200.2
srv-r	IN	A	192.168.250.2
...
@	IN SOA	@ rname.invalid. (
					...
					3H )	; minimum
	IN	NS	au-team.irpo.
1	IN	PTR	rtr-l.au-team.irpo.
2	IN	PTR	srv-l.au-team.irpo.
```
